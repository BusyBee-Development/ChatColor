...
public class Warning {
    ...
    public static void send(ChatColor plugin) {
        ...
        plugin.getLogger().warning("⚠️ Notice: Placeholder syntax/handling has changed in v26.7.2!");
        ...
        plugin.getLogger().warning("This message will be taken away in the next major release.");
        plugin.getLogger().warning("==================================================");
    }
}
