...
import net.busybee.chatcolor.command.ChatColorAdminCommand;
...
import net.busybee.chatcolor.gui.GuiListener;
import net.busybee.chatcolor.hook.ChatControlHook;
import net.busybee.chatcolor.pattern.manager.PatternManager;
import net.busybee.chatcolor.updatechecker.UpdateChecker;
import net.busybee.chatcolor.util.Util;
import org.bstats.bukkit.Metrics;
import org.bukkit.command.ConsoleCommandSender;
import net.busybee.chatcolor.placeholderapi.ChatColorPlaceholders;
import java.sql.*;
