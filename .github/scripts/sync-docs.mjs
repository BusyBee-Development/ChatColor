...
const SECTION_MAP = {
    ...
    advanced: { title: 'Advanced', sortOrder: 6 },
    support: { title: 'Support', sortOrder: 7 },
};

// Root-level files that are meta and not real doc pages.
const EXCLUDED_ROOT_FILES = new Set(['README.md']);
